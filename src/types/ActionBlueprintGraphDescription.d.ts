...
// JSON schemas were crawled usinig getSchemas.py in the proj root starting at url:
// https://api.avantos-dev.io/schemas/ActionBlueprintGraphDescription

// my original attempt was to use the JSON schemas themselves but there seems to be some bugs
// in the types codified therein as of now ...
...
// command that generated this file is:
// npx json2ts ActionBlueprintGraphDescription.json > ActionBlueprintGraphDescription.d.ts
